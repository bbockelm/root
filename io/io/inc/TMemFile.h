...
public:
   TMemFile(const char *name, Option_t *option="", const char *ftitle="", ROOT::CompressionSetting compress=ROOT::kUseGlobalCompressionSetting);
   TMemFile(const char *name, char *buffer, Long64_t size, Option_t *option="", const char *ftitle="", ROOT::CompressionSetting compress=ROOT::kUseGlobalCompressionSetting);
